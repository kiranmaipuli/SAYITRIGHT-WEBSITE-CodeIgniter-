...
<body>
	<div class="wrapper">
		<div class="start">
				...
				<li><a id="active" href="<?php echo site_url('Conference_admin_control/conference_admin_calling'); ?>">CONFERENCES</a></li>
...
<div class="confercontainer">
	<div class="innerconfercontainer">
		...
		<table>
				...
				echo form_open('Conference_admin_control/updating_info');
			...
			<?php
				...
				echo form_open('Conference_admin_control/adding_info');
