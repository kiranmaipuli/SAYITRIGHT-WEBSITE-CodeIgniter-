...
<body>
		...
		<?php 
			echo form_open('individual_signup_controller/individual_validation'); ?>
...
<?php		
	...
	echo form_error('placework');
	echo form_input(['type' => 'text', 'name' => 'placework','value' => set_value('placework') ,'placeholder' => 'Enter place work', 'id' =>'elementposition']);

	echo form_error('school');
	echo form_input(['type' => 'text', 'name' => 'school','value' => set_value('school') ,'placeholder' => 'Enter school', 'id' =>'elementposition']);
	...
	echo form_submit(['type' => 'submit', 'value' => 'SEND', 'class' => 'button', 'id' => 'inputbutton3', 'name' => 'send']);
